...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'PhotoManager_photo', 'image', self.gf('sorl.thumbnail.fields.ImageField')(max_length=100))

    def backwards(self, orm):

        # Changing field 'Photo.image'
        db.alter_column(u'PhotoManager_photo', 'image', self.gf('django.db.models.fields.files.ImageField')(max_length=100))
